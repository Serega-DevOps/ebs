...
<body>
    <section class="congratulations">
        <h1>Serega!Congratulations!</h1>
        <p>Serega DevOps deploy new version of PHP application <em>PHP</em> application is now running on your own dedicated environment in the AWS&nbsp;Cloud</p>
